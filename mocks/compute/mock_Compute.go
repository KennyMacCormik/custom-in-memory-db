...
func (_m *MockCompute) Close() error {
	ret := _m.Called()
...
// MockCompute_Close_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Close'
type MockCompute_Close_Call struct {
	*mock.Call
}

// Close is a helper method to define mock.On call
func (_e *MockCompute_Expecter) Close() *MockCompute_Close_Call {
	return &MockCompute_Close_Call{Call: _e.mock.On("Close")}
}

func (_c *MockCompute_Close_Call) Run(run func()) *MockCompute_Close_Call {
...
func (_c *MockCompute_Close_Call) Return(_a0 error) *MockCompute_Close_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockCompute_Close_Call) RunAndReturn(run func() error) *MockCompute_Close_Call {
	_c.Call.Return(run)
	return _c
}
